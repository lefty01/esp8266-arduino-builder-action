...
BUILDER_OPTIONS="-hardware $BUILDER_PATH/platforms  $BUILDER_PATH/hardware -tools $BUILDER_PATH/hardware/tools/avr -tools $BUILDER_PATH/tools-builder `getLibraryOptions $LIBRARIES_PATH` -fqbn $BOARD_NAME -prefs=runtime.tools.xtensa-lx106-elf-gcc.path=$BUILDER_PATH/packages/esp8266/tools/xtensa-lx106-elf-gcc/2.5.0-3-20ed2b9"
